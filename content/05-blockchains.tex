...
\KM{feels ok although it looks brief. Maybe "what can go wrong"}
...
\KM{could benefit from more extensive coverage of other solutions using DLT and evoting}
...
\KM{maybe more refs on attacks and their significance}