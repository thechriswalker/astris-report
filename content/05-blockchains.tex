...
Here is a simple figure showing the core structure of a blockchain. Implementations will vary the specifics but the concepts remain.
...
Here is a representation of data in a simple blockchain. Note that the structure of the most famous blockchain (as used in BitCoin \needcite{bitcoin}) is quite different, but the core concepts are the same here.
