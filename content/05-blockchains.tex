...
Cryptocurrencies may have brought blockchains into the limelight, but they are only one use of the technology. Blockchains can and have been used for ... \todo{ more blockchain\\
    public audit logs \\
    smart contract executors \\
    domain names --- maybe another example of censorship resistant tech \\
}
