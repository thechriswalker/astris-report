...
\todo{
    ...
    blockchain crypto \cite{yu_platform-independent_2018}

    cryptocurrency based: running atop a generic cryptocurrency system such as bitcoin \needcite{zhao chan, private voting} or zcash \cite{tarasov_internet_2017}

    smart contract based: using smart contracts to enfore their rules. This implies running on an existing blockchain w th smart contract support, like ethereum or hyperledger fabric. \cite{mccorry_smart_2017} (limitations.)
}
